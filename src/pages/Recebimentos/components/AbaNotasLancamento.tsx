...
import type { RecebimentoFluxoView } from '../types/recebimento.types';
...
export default function AbaNotasLancamento({
    ...
    // Temporizador local (segundos decorridos/restantes por fluxo)
    ...
    const carregarDocumentos = async () => {
        try {
            ...
            // Inicializa temporizadores com base no tempo de SLA
    ...
    // 2. Registrar Pausa do Temporizador
    ...
    // 3. Finalizar Lançamento (Fase 6) com Link do Relatório
    const handleConfirmarFinalizacao = async () => {
        ...
        try {
            ...
            alert('Lançamento concluído! Documento encaminhado para a Gôndola.');
    ...
    return (
        <div className="flex flex-col gap-4">
                        ...
                        return (
                            ...
                            >
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className={`p-3 rounded-2xl border flex items-center justify-between ${tempoEsgotado
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {(['Intervalo', 'Outros'] as const).map((m) => (
                                    <button
                                        ...
                                        className={`py-2 rounded-xl text-xs font-black uppercase border transition-all cursor-pointer ${motivoPausa === m
            ...
            {/* Modal de Finalização de Lançamento (Link Obrigatório) */}
            {itemParaFinalizar && (
                <div
                    className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-3 animate-fadeIn"
                    ...
                    >
                        ...
                        <div>
                            ...
                            <span className="text-[10px] text-slate-400 mt-1 block">
                                Este link ficará acessível para a equipe de gôndola na próxima fase.
                            </span>
                        </div>

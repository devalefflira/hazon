        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium">
              {etapa === 1 ? 'Etapa 1: Destino e Finalidade' : `Etapa 2: Lançamento de Itens (${localEscolhido})`}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 py-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              {LOCAIS_CONSUMO.map((loc) => (
                <button
                  ...
                  className={`p-3.5 rounded-2xl border text-xs font-black uppercase transition-all flex items-center justify-center text-center cursor-pointer ${
                    localEscolhido === loc
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div
                ...
                className={`cursor-pointer p-4 rounded-3xl border-2 transition-all flex flex-col gap-1.5 ${
                  finalidadeEscolhida === 'Consumo/Despesa'
                    ? 'border-[#09797a] bg-teal-50/40 shadow-xs'
              ...
              >
                ...
                <p className="text-xs text-slate-500 font-medium leading-relaxed">
                  Materiais de limpeza, expediente ou uso direto. <strong>Deduz do limite mensal do setor</strong>.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-xs text-slate-500 font-medium leading-relaxed">
                  Insumos que viram outro produto final. <strong>Não reduz o teto de gastos do setor</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end gap-2 pt-4 border-t border-slate-100">
            <button
              type="button"
              onClick={onVoltar}
              className="px-5 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-bold text-xs uppercase cursor-pointer"
            >
              Cancelar
            </button>
            <button
              type="button"
              onClick={() => setEtapa(2)}
              className="px-6 py-2.5 rounded-xl bg-[#09797a] hover:bg-[#075f60] text-white font-black text-xs uppercase shadow-md active:scale-95 transition-all cursor-pointer"
            >
              Avançar para Itens →
            </button>
          </div>
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => setEtapa(1)}
              className="text-[11px] font-bold text-[#09797a] hover:underline uppercase cursor-pointer"
            >
              Alterar Contexto
            </button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-100">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <button
                type="button"
                onClick={onVoltar}
                className="flex-1 sm:flex-none px-5 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-bold text-xs uppercase cursor-pointer"
              >
                Cancelar
              </button>
              <button
                ...
                className="flex-1 sm:flex-none px-6 py-2.5 rounded-xl bg-[#09797a] hover:bg-[#075f60] disabled:opacity-50 text-white font-black text-xs uppercase shadow-md active:scale-95 transition-all cursor-pointer"
              >
